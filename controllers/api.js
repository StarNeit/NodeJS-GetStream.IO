...
exports.postFileUpload = (req, res, next) => {
  if (req.file){
    req.session['uploaded_file'] = "/uploads/" + req.file.filename;
    req.flash('success', { msg: 'File was uploaded successfully.' });
  }
  else {
    req.session['uploaded_file'] = "";
    req.flash('success', { msg: 'Please choose file.' });
  }
  res.redirect('/api/upload');
};

exports.postFileUploadProfile = (req, res, next) => {
  if (req.file){
    req.session['uploaded_file'] = "/uploads/" + req.file.filename;
    req.flash('success', { msg: 'File was uploaded successfully.' });
  }
...
exports.postFeedImg = (req, res, next) => {
  if (req.file){
    req.session['uploaded_file'] = "/uploads/" + req.file.filename;
    req.flash('success', { msg: 'File was uploaded successfully. Please post feed with this image.' });
  }
  else {
    req.session['uploaded_file'] = "";
    req.flash('success', { msg: 'Please choose file.' });
